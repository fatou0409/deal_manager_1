...
function Icon({ name, className = "h-5 w-5" }) {
  ...
  switch (name) {
    case "home":
      return (<svg viewBox="0 0 24 24" {...props}><path d="M3 10.5 12 3l9 7.5"/><path d="M5 10v10h14V10"/></svg>);
    case "dashboard":
      return (<svg viewBox="0 0 24 24" {...props}><rect x="3" y="3" width="7" height="7"/><rect x="14" y="3" width="7" height="7"/><rect x="14" y="14" width="7" height="7"/><rect x="3" y="14" width="7" height="7"/></svg>);
    case "target":
      return (<svg viewBox="0 0 24 24" {...props}><circle cx="12" cy="12" r="8"/><circle cx="12" cy="12" r="3"/></svg>);
    case "briefcase":
      return (<svg viewBox="0 0 24 24" {...props}><path d="M4 7h16a2 2 0 0 1 2 2v8H2V9a2 2 0 0 1 2-2Z"/><path d="M9 7V5a2 2 0 0 1 2-2h2a2 2 0 0 1 2 2v2"/></svg>);
    case "calendar":
      return (<svg viewBox="0 0 24 24" {...props}><rect x="3" y="4" width="18" height="18" rx="2"/><path d="M16 2v4M8 2v4M3 10h18"/></svg>);
    case "users":
      return (<svg viewBox="0 0 24 24" {...props}><path d="M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M22 21v-2a4 4 0 0 0-3-3.87"/><path d="M16 3.13a4 4 0 0 1 0 7.75"/></svg>);
    default:
      return null;
  }
}
...
/** Sidebar blanche, pleine hauteur, SANS bordures ni titres */
    ...
    <aside className="w-64 shrink-0">
      <div className="sticky top-16 h-[calc(100vh-64px)] overflow-y-auto bg-white px-4 py-6 shadow-xl rounded-r-3xl border-r border-gray-100">
        <nav className="flex flex-col gap-1">
          {/* ...branding supprimé pour éviter la redondance */}
          ...
          <Item to="/deals" icon="briefcase" label="Deals" badge={badges.deals} />
          <Item to="/visits" icon="calendar" label="Visites & Suivi" badge={badges.visits} />
